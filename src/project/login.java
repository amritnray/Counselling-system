          ...
          if(result.next())
                  {
                     ...
                     if(m== null) {
                         a=result.getString(7).toCharArray();
                          id1=result.getInt(1);
                          
                          c1.set_id1(id1);
                          
                          char[] pass1=jPasswordField1.getText().toCharArray();
                          if(!Arrays.equals(a, pass1))
                          {
                              JOptionPane.showMessageDialog(rootPane, "password miss match error");
                         ...
                         JOptionPane.showMessageDialog(rootPane," Prefrence is already given");
                     }
